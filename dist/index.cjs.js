...
var sdkuni = require('@wukongfinance/sdkuni');
...
var Icon$11 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { id: "path993", d: "M10.594,15.409h2.87v6.45h-2.87V15.409" }),
        React__default['default'].createElement("path", { id: "path991", d: "M3.958,8.806h4.877L5.363,5.519l1.913-1.95l3.304,3.379V2.14h2.87v4.807l3.302-3.379\n        l1.913,1.95l-3.472,3.287h4.879v2.718h-4.909l3.489,3.379l-1.914,1.903L12,12.061l-4.739,4.745l-1.914-1.903l3.488-3.379H3.928\n        V8.806H3.958" })));
};

var Icon$12 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M6.446,11.461c0-0.452,0.367-0.818,0.819-0.818h0.004l1.364,0.004c0.452,0,0.82,0.367,0.82,0.82\n        v5.159c0.153-0.046,0.349-0.096,0.566-0.146c0.31-0.071,0.527-0.348,0.527-0.666V9.418c0-0.453,0.367-0.82,0.819-0.82h1.368\n        c0.455,0,0.82,0.367,0.82,0.82v5.938c0,0,0.343-0.139,0.677-0.278c0.254-0.107,0.418-0.356,0.418-0.63v-7.08\n        c0-0.453,0.366-0.82,0.819-0.82h1.368c0.452,0.001,0.817,0.367,0.817,0.82v5.829c1.186-0.858,2.386-1.891,3.34-3.133\n        c0.28-0.366,0.359-0.848,0.209-1.284c-1.75-5.037-7.251-7.701-12.288-5.95C3.878,4.58,1.215,10.082,2.965,15.117\n        c0.197,0.569,0.448,1.116,0.747,1.639c0.238,0.41,0.693,0.646,1.166,0.604c0.258-0.021,0.58-0.055,0.963-0.102\n        c0.344-0.038,0.604-0.33,0.605-0.677V11.461" }),
        React__default['default'].createElement("path", { d: "M6.417,19.734c4.312,3.138,10.353,2.184,13.49-2.129c1.202-1.65,1.848-3.642,1.848-5.682\n        c0-0.222-0.01-0.442-0.025-0.661C18.201,16.525,11.687,18.985,6.417,19.734" })));
};

var Icon$13 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M10.002,9.974H9.003V8.975c0-0.552-0.447-0.999-0.999-0.999S7.005,8.423,7.005,8.975v0.999H6.006\n        c-0.551,0-0.999,0.447-0.999,0.999s0.447,0.999,0.999,0.999h0.999v0.998c0,0.553,0.447,1,0.999,1s0.999-0.447,0.999-1v-0.998h0.999\n        c0.552,0,0.999-0.447,0.999-0.999S10.554,9.974,10.002,9.974z" }),
        React__default['default'].createElement("path", { d: "M23.408,12.583c-0.604-2.335-1.546-4.688-2.482-6.643c-0.014-0.083-0.075-0.336-0.096-0.419\n        C20.775,5.31,20.728,5.147,20.672,5c-0.152-0.397-0.301-0.636-0.719-0.795l-2.908-1.105c-0.564-0.214-1.195-0.136-1.691,0.211\n        l-0.098,0.069l-0.08,0.09c-0.082,0.093-0.216,0.239-0.357,0.382c-0.037,0.039-0.037,0.039-0.076,0.076\n        c-0.018,0.018-0.035,0.035-0.053,0.051H9.334C9.283,3.927,9.283,3.927,9.245,3.884C9.117,3.744,8.996,3.599,8.923,3.508l-0.09-0.113\n        L8.715,3.312C8.219,2.965,7.588,2.886,7.023,3.101L4.116,4.206c-0.42,0.16-0.567,0.398-0.719,0.797\n        C3.342,5.149,3.294,5.311,3.241,5.521C3.222,5.595,3.162,5.843,3.15,5.888c-0.902,1.817-1.942,4.354-2.561,6.719\n        c-1.005,3.833-0.813,6.7,1.272,8.079c0.642,0.424,1.478,0.346,2.044-0.16l3.46-3.102c0.307-0.275,0.692-0.426,1.09-0.426h7.156\n        c0.398,0,0.784,0.15,1.09,0.424l3.459,3.102c0.573,0.512,1.425,0.596,2.065,0.148C24.234,19.264,24.4,16.41,23.408,12.583z\n        M21.294,18.855l-3.257-2.92c-0.671-0.602-1.531-0.934-2.425-0.934H8.456c-0.893,0-1.753,0.332-2.424,0.934l-3.267,2.93\n        c-0.92-0.846-0.997-2.879-0.244-5.752c0.578-2.207,1.567-4.621,2.414-6.29C5,6.695,5.034,6.585,5.085,6.383\n        c0.015-0.059,0.076-0.308,0.091-0.369c0.008-0.029,0.015-0.057,0.021-0.083l2.388-0.907c0.056,0.064,0.116,0.133,0.178,0.201\n        C7.816,5.283,7.816,5.283,7.87,5.341c0.465,0.491,0.641,0.638,1.133,0.638h5.994c0.476,0,0.646-0.134,1.144-0.622\n        c0.051-0.05,0.051-0.05,0.101-0.101c0.081-0.082,0.157-0.162,0.228-0.237l2.403,0.913c0.007,0.026,0.015,0.054,0.022,0.084\n        c0.018,0.07,0.078,0.32,0.09,0.365c0.05,0.197,0.081,0.301,0.141,0.424c0.885,1.846,1.783,4.092,2.35,6.279\n        C22.215,15.939,22.16,17.982,21.294,18.855z" }),
        React__default['default'].createElement("path", { d: "M15.996,8.975c0.551,0,0.998-0.447,0.998-0.999c0-0.551-0.447-0.999-0.998-0.999\n        c-0.552,0-0.999,0.447-0.999,0.999C14.997,8.528,15.444,8.975,15.996,8.975z" }),
        React__default['default'].createElement("path", { d: "M15.996,10.973c-0.552,0-0.999,0.447-0.999,0.999c0,0.551,0.447,0.998,0.999,0.998\n        c0.551,0,0.998-0.447,0.998-0.998C16.994,11.42,16.547,10.973,15.996,10.973z" }),
        React__default['default'].createElement("path", { d: "M13.998,8.975c-0.552,0-0.999,0.448-0.999,0.999s0.447,0.999,0.999,0.999\n        c0.551,0,0.999-0.448,0.999-0.999S14.549,8.975,13.998,8.975z" }),
        React__default['default'].createElement("path", { d: "M17.994,8.975c-0.552,0-1,0.448-1,0.999s0.448,0.999,1,0.999c0.551,0,0.998-0.448,0.998-0.999\n        S18.545,8.975,17.994,8.975z" })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    TradeIcon: Icon$$,
    TwitterIcon: Icon$10,
    LinktreeIcon: Icon$11,
    EtherscanIcon: Icon$12,
    GamepadIcon: Icon$13,
    ShieldIcon: Icon$14,
    BushIcon: Icon$15,
    DiscordIcon: Icon$16
...
var MenuLink = function (_a) {
    ...
    var isMailLink = href === null || href === void 0 ? void 0 : href.startsWith("mailto");
...
var StyledSoon = styled__default['default'].span(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"], ["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"])));
...
var templateObject_1$F, templateObject_2$f, templateObject_3$7;
...
var _a$2, _b$1;
var SCAN_URL = (_a$2 = {},
    _a$2[sdkuni.ChainId.MAINNET] = 'https://etherscan.io/address/',
    _a$2[sdkuni.ChainId.RINKEBY] = 'https://rinkeby.etherscan.io/address/',
    _a$2[sdkuni.ChainId.BSCNET] = 'https://bscscan.com/address/',
    _a$2[sdkuni.ChainId.BSCTESTNET] = 'https://bscscan.com/address/',
    _a$2[sdkuni.ChainId.FANTOMNET] = 'https://ftmscan.com/address/',
    _a$2[sdkuni.ChainId.FANTOMTESTNET] = 'https://ftmscan.com/address/',
    _a$2[sdkuni.ChainId.HARMONYNET] = 'https://explorer.harmony.one/address/',
    _a$2[sdkuni.ChainId.HARMONYTESTNET] = 'https://explorer.harmony.one/address/',
    _a$2);
var SCAN_NAME = (_b$1 = {},
    _b$1[sdkuni.ChainId.MAINNET] = 'EtherScan',
    _b$1[sdkuni.ChainId.RINKEBY] = 'Rinkeby EtherScan',
    _b$1[sdkuni.ChainId.BSCNET] = 'BscScan',
    _b$1[sdkuni.ChainId.BSCTESTNET] = 'BscScan',
    _b$1[sdkuni.ChainId.FANTOMNET] = 'FtmScan',
    _b$1[sdkuni.ChainId.FANTOMTESTNET] = 'FtmScan',
    _b$1[sdkuni.ChainId.HARMONYNET] = 'Harmony Explorer',
    _b$1[sdkuni.ChainId.HARMONYTESTNET] = 'Harmony Explorer',
    _b$1);
...
var useWalletModal = function (login, logout, account, chainId) {
    ...
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { account: account || "", chainId: chainId || 1, logout: logout }))[0];
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        ...
        React__default['default'].createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(6)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var templateObject_1$K, templateObject_2$h, templateObject_3$8, templateObject_4$3, templateObject_5$1;
...
var StyledNav$1 = styled__default['default'].nav(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$M, templateObject_2$i, templateObject_3$9, templateObject_4$4;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#FF720D", activeButton: "#397f49", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9f1fd", background: "#1f2b46", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#0a0e17", input: "#483f3b", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", primaryDark: "#d95b00", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#FF720D", activeButton: "#397f49", borderColor: "#524B63", card: "rgba(18,24,39,0.8)", nav: "#130119", gradients: {
