...
var StyledSoon = styled.span(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"], ["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"])));
...
var _a$2, _b$1;
var SCAN_URL = (_a$2 = {},
    _a$2[ChainId.MAINNET] = 'https://etherscan.io/address/',
    _a$2[ChainId.RINKEBY] = 'https://rinkeby.etherscan.io/address/',
    _a$2[ChainId.BSCNET] = 'https://bscscan.com/address/',
    ...
    _a$2);
var SCAN_NAME = (_b$1 = {},
    _b$1[ChainId.MAINNET] = 'EtherScan',
    _b$1[ChainId.RINKEBY] = 'Rinkeby EtherScan',
    _b$1[ChainId.BSCNET] = 'BscScan',
...
var useWalletModal = function (login, logout, account, chainId) {
    ...
    var onPresentAccountModal = useModal(React.createElement(AccountModal, { account: account || "", chainId: chainId || 1, logout: logout }))[0];
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, null,
        ...
        React.createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(6)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var StyledNav$1 = styled.nav(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
